        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="rounded-2xl border border-neutral-200 p-8 space-y-4 bg-white">
              ...
              <Link to="/teams/usc-aerodesign-2026-2027"><Button variant="outline">See More</Button></Link>
            </div>
            <div className="rounded-2xl border border-neutral-200 p-8 space-y-4 bg-white">
              ...
              <Link to="/teams/usc-aerodesign-2025-2026"><Button variant="outline">See More</Button></Link>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="rounded-2xl border border-neutral-200 p-8 space-y-4 bg-white">
              ...
              <Link to="/teams/cove-terra-labs"><Button variant="outline">See More</Button></Link>
            </div>
            <div className="rounded-2xl border border-neutral-200 p-8 space-y-4 bg-white">
              ...
              <Link to="/teams/terraport-terra-labs"><Button variant="outline">See More</Button></Link>
            </div>
          </div>
        </section>
      </div>
